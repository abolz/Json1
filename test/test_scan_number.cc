...
TEST_CASE("ScanNumber")
{
    static const ScanNumberTest tests[] = {
        ...
        {"-0", json::NumberClass::integer},
        {"123e65", json::NumberClass::floating_point},
        {"0e+1", json::NumberClass::floating_point},
        {"0e1", json::NumberClass::floating_point},
        {"4", json::NumberClass::integer},
        {"-0.0000000000000000000000000000001", json::NumberClass::floating_point},
        {"20e1", json::NumberClass::floating_point},
        {"-123", json::NumberClass::integer},
        {"-1", json::NumberClass::integer},
        {"1E22", json::NumberClass::floating_point},
        {"1E-2", json::NumberClass::floating_point},
        {"1E+2", json::NumberClass::floating_point},
        {"123e45", json::NumberClass::floating_point},
        {"123.456e78", json::NumberClass::floating_point},
        {"1e-2", json::NumberClass::floating_point},
        {"1e+2", json::NumberClass::floating_point},
        {"123", json::NumberClass::integer},
        {"123.456789", json::NumberClass::floating_point},
        {"123.456e-789", json::NumberClass::floating_point},
        {"0.4e0066999999999999999999999999999999999999999999999999999999999999999999999999999006", json::NumberClass::floating_point},
        {"-1e+9999", json::NumberClass::floating_point},
        {"1.5e+9999", json::NumberClass::floating_point},
        {"-123123e100000", json::NumberClass::floating_point},
        {"123123e100000", json::NumberClass::floating_point},
        {"123e-10000000", json::NumberClass::floating_point},
        {"-123123123123123123123123123123", json::NumberClass::integer},
        {"-1.0e+123123123123123123123123123123", json::NumberClass::floating_point},
        {"1.0e-123123123123123123123123123123", json::NumberClass::floating_point},
        ...
        {"-1.0.", json::NumberClass::floating_point, 4},
        {"0.1.2", json::NumberClass::floating_point, 3},
        ...
        {"-123.123foo", json::NumberClass::floating_point, 8},
        {"123\345", json::NumberClass::integer, 3},
        {"1e1\345", json::NumberClass::floating_point, 3},
        {"1.1e1\345", json::NumberClass::floating_point, 5},
        {"0\345", json::NumberClass::integer, 1},
        {"-1x", json::NumberClass::integer, 2},
        {"1.2a-3", json::NumberClass::floating_point, 3},
        {"1.8011670033376514H-308", json::NumberClass::floating_point, 18},
    };
...
TEST_CASE("ScanNumber - allow_nan_inf")
{
    static const ScanNumberTest tests[] = {
        //
        // Valid inputs.
        //
        {"Infinity", json::NumberClass::pos_infinity},
        {"-Infinity", json::NumberClass::neg_infinity},
        {"NaN", json::NumberClass::nan},
        {"-NaN", json::NumberClass::nan},
    ...
    for (auto const& test : tests)
    {
        ...
        auto const snr = json::ScanNumber(next, last, options);
        EXPECT_EQUALS(test.nc, snr.number_class);
        EXPECT_EQUALS(test.pos, snr.next - next);
    }
}
