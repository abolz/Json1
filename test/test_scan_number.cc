...
TEST_CASE("ScanNumber")
{
    static const ScanNumberTest tests[] = {
        ...
        {"-0", json::NumberClass::integer},
        {"123e65", json::NumberClass::decimal},
        {"0e+1", json::NumberClass::decimal},
        {"0e1", json::NumberClass::decimal},
        {"4", json::NumberClass::integer},
        {"-0.0000000000000000000000000000001", json::NumberClass::decimal},
        {"20e1", json::NumberClass::decimal},
        {"-123", json::NumberClass::integer},
        {"-1", json::NumberClass::integer},
        {"1E22", json::NumberClass::decimal},
        {"1E-2", json::NumberClass::decimal},
        {"1E+2", json::NumberClass::decimal},
        {"123e45", json::NumberClass::decimal},
        {"123.456e78", json::NumberClass::decimal},
        {"1e-2", json::NumberClass::decimal},
        {"1e+2", json::NumberClass::decimal},
        {"123", json::NumberClass::integer},
        {"123.456789", json::NumberClass::decimal},
        {"123.456e-789", json::NumberClass::decimal},
        {"0.4e0066999999999999999999999999999999999999999999999999999999999999999999999999999006", json::NumberClass::decimal},
        {"-1e+9999", json::NumberClass::decimal},
        {"1.5e+9999", json::NumberClass::decimal},
        {"-123123e100000", json::NumberClass::decimal},
        {"123123e100000", json::NumberClass::decimal},
        {"123e-10000000", json::NumberClass::decimal},
        {"-123123123123123123123123123123", json::NumberClass::integer},
        {"-1.0e+123123123123123123123123123123", json::NumberClass::decimal},
        {"1.0e-123123123123123123123123123123", json::NumberClass::decimal},
        ...
        {"1e1\345", json::NumberClass::decimal, 3},
        {"1.1e1\345", json::NumberClass::decimal, 5},
