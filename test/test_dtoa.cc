...
static charconv_internal::DoubleToDecimalResult NonNegativeDoubleToDecimal(double value)
{
    return charconv_internal::DoubleToDecimal(value);
}

TEST_CASE("Ryu_Regression")
{
    charconv_internal::DoubleToDecimalResult res;
